...
**Do not fund or open Hack Juno epochs until JV-01 and JV-02 are fixed and the
deployed gauge is upgraded.**
...
The full report is in [SECURITY_AUDIT.md](SECURITY_AUDIT.md). The live-chain
queries used to establish the current blast radius are summarized in
...
2. Fix and migrate the snapshot gauge for JV-01 and JV-02.
