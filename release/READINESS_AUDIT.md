...
| Gauge changes accepted upstream and cleanly pinned | Local commit/pin complete; upstream acceptance pending | The changes are committed locally as `06cc36c2a200ec62abd8d27052918c4067d9c2ba` on `feat/juno-voice-epoch-snapshot-gauge`, and the parent gitlink pins that commit. The commit must still be pushed, reviewed, and accepted upstream before release. |
